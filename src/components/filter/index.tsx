...
export default function SidebarMenu({
  ...
  return (
    <div className={`${className} transition-all duration-300 ${isMenuOpen ? "w-[20rem] px-[3rem]" : "w-16"} bg-white border-r border-gray-200 shadow-lg flex flex-col p-4 max-sm:hidden overflow-y-auto sticky top-0 h-screen`}>
