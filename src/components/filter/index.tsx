...
export default function SidebarMenu({
  ...
  return (
    <div className={`${className} transition-all h-[70vh] duration-300 ${isMenuOpen ? "w-[20rem] px-[3rem]" : "w-16"} bg-[#F7F7F7] shadow-lg flex flex-col p-4 rounded-b-[10px] max-sm:hidden`}>
