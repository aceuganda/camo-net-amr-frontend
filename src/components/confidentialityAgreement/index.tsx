  ...
  return (
    <div className="flex flex-col justify-center items-center h-[40rem] bg-gray-100 p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-3xl w-full h-[80vh] overflow-y-auto" onScroll={handleScroll}>
        ...
        <p className="mb-4">
          This Agreement is entered into on this {`${day} day of ${month}, ${year}`} by and between the Infectious Diseases Institute (IDI), a company registered under the Personal Data Protection and Privacy Act 2019 and having its registered office at Mulago (hereinafter referred to as “IDI”, which term, unless repugnant to the context, would include its successors in interest) of the First Part, and the person agreeing to this Agreement of the Second Part.
        </p>
        
        <p className="mb-4">
          WHEREAS, IDI represents that it now has, or may in the future obtain, certain ideas, concepts, data, or other information from their clients (Study subjects/HIV Patients) which in whole or in part is or will be considered proprietary, in particular, but not limited to, information on the following subject(s): pre-clinical data, patient data, medical data, Laboratory data, pharmacy data, clinical trial data, clinical trial material/device/drug information (hereinafter agreed to as &ldquo;Confidential Information&ldquo;).
        </p>
        ...
        <p className="mb-4">
          7. This Agreement constitutes the entire agreement of the parties with respect to the PartiesIt&#39; respective obligations in connection with Information disclosed hereunder and supersedes all prior oral and written agreements and discussions with respect thereto.
        </p>
        
        <p className="mb-4">
          8. This Agreement will remain in effect for any time period the person will be in possession of the IDI data or Confidential Information even when they are no longer working with IDI.
        </p>
        ...
        <p className="mb-4">
          10. Any dispute or difference arising out of or in connection with this Agreement shall be settled by the parties hereto by mutual negotiation. Any unsettled dispute or difference shall be referred to Arbitration in accordance with the Uganda Data Protection and Privacy Act, 2019. The venue of arbitration proceedings shall be at any competent court with jurisdiction to hear this dispute. This clause does not waive IDIIt&#39;s right to approach the appropriate court of law having competent jurisdiction to settle/claim any dispute or claim between the parties.
        </p>
