  ...
  return (
    ...
    >
      ...
      <div className="w-[95%] sm:w-[70%] max-w-4xl h-auto mt-[3rem] bg-white rounded-[10px] shadow-box z-10 p-6 sm:p-12 relative">
        ...
        <p className="mb-4">
        On this home page, you will find a a few of metrics and visualizations, including interactive graphs, charts, and choropleth maps that provide insights into the prevalence of AMR in different regions. These tools are designed to help you grasp the significance and scale of the data before you request access. 
        </p>
        ...
        If you have any questions or need further assistance, please feel free to contact us at {" "}
          <a
            href="amrportaluganda@gmail.com"
